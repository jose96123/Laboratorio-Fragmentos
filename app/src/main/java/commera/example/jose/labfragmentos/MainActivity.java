package commera.example.jose.labfragmentos;
...
import commera.example.jose.labfragmentos.utils.GalleryStructure;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void loaddata() {
        this.list = new ArrayList<GalleryStructure>();
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            ...
            ImageView img = rootView.findViewById(R.id.portada);
            TextView txt = rootView.findViewById(R.id.description);
